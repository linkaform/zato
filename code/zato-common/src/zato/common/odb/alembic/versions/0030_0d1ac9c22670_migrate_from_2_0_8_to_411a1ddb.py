...
def upgrade():
    ...
    sa.Column('id', sa.Integer(), sa.Sequence('kv_data_id_seq'), nullable=False),
    ...
    sa.Column('id', sa.Integer(), sa.Sequence('out_stomp_id_seq'), nullable=False),
    ...
    sa.Column('id', sa.Integer(), sa.ForeignKey('sec_base.id'), nullable=False),
    sa.Column('ttl', sa.Integer(), nullable=False),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_table('channel_web_socket',
    sa.Column('id', sa.Integer(), sa.Sequence('channel_web_socket_id_seq'), nullable=False),
    sa.Column('name', sa.String(length=200), nullable=False),
    sa.Column('is_active', sa.Boolean(), nullable=False),
    ...
    sa.Column('id', sa.Integer(), sa.Sequence('channel_stomp_id_seq'), nullable=False),
    sa.Column('name', sa.String(length=200), nullable=False),
    sa.Column('is_active', sa.Boolean(), nullable=False),
    sa.Column('username', sa.String(length=200), server_default='guest', nullable=True),
    sa.Column('password', sa.String(length=200), nullable=True),
    ...
    sa.Column('id', sa.Integer(), sa.Sequence('web_socket_client_id_seq'), nullable=False),
    sa.Column('is_internal', sa.Boolean(), nullable=False),
    ...
    sa.Column('id', sa.Integer(), sa.Sequence('web_socket_sub_id_seq'), nullable=False),
    sa.Column('is_internal', sa.Boolean(), nullable=False),
