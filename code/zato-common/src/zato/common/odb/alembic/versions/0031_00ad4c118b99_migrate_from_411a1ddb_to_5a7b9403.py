...
def upgrade():
    ...
    sa.Column('id', sa.Integer(), sa.Sequence('sms_twilio_id_seq'), nullable=False),
    ...
    sa.Column('id', sa.Integer(), sa.Sequence('cache_id_seq'), nullable=False),
    sa.Column('name', sa.String(length=200), nullable=False),
    sa.Column('is_active', sa.Boolean(), nullable=False),
    ...
    sa.Column('id', sa.Integer(), sa.Sequence('pubsub_topic_id_seq'), nullable=False),
    sa.Column('name', sa.String(length=200), nullable=False),
    sa.Column('is_active', sa.Boolean(), nullable=False),
    sa.Column('is_internal', sa.Boolean(), nullable=False),
    ...
    sa.Column('id', sa.Integer(), sa.Sequence('pubsub_endpoint_id_seq'), nullable=False),
    sa.Column('name', sa.String(length=200), nullable=False),
    sa.Column('is_internal', sa.Boolean(), nullable=False),
    sa.Column('is_active', sa.Boolean(), nullable=False),
    ...
    sa.Column('id', sa.Integer(), sa.Sequence('pubsub_sub_id_seq'), nullable=False),
    sa.Column('is_internal', sa.Boolean(), nullable=False),
    ...
    sa.Column('id', sa.Integer(), sa.Sequence('pubsub_message_id_seq'), nullable=False),
    ...
    sa.Column('id', sa.Integer(), sa.Sequence('web_socket_cli_ps_seq'), nullable=False),
    sa.Column('sub_key', sa.String(length=200), nullable=False),
    ...
    sa.Column('id', sa.Integer(), sa.Sequence('pubsub_endpt_seq'), nullable=False),
    sa.Column('pattern_matched', sa.Text(), nullable=False),
    ...
    sa.Column('id', sa.Integer(), sa.Sequence('pubsub_msg_seq'), nullable=False),
    sa.Column('creation_time', sa.BigInteger(), nullable=False),
